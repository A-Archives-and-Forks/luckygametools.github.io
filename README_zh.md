...
墙内的铁汁们下载链接打不开的可以试试这个网盘  (<a href="https://gofile.io/d/Evq2mz" target="_blank">点击直达</a> )
...
- 部分启动不了或者卡住或者提示連接失敗需要登陸上線驗證的游戏(eg:微软飞行模拟器)，参数搞不定的可以联系([電報群](https://t.me/luckygametools))
- 小部分游戏只针对有贡献的用户开放
